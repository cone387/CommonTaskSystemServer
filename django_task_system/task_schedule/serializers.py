from . import models
from common_objects.serializers import CommonCategorySerializer, CommonTagSerializer
...
class QueueScheduleSerializer(TaskScheduleSerializer):
    ...
    class Meta:
        model = models.TaskSchedule
        fields = ('id', 'task', 'schedule_type', 'next_schedule_time', 'update_time', 'callback', 'user')
