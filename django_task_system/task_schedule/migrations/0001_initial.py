...
import django_task_system.common_objects.fields
import django_task_system.common_objects.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config', django_task_system.common_objects.fields.ConfigField(blank=True, default=django_task_system.common_objects.models.get_default_config('Task'), null=True, verbose_name='参数')),
                ('status', django_task_system.common_objects.fields.CharField(choices=[('E', '启用'), ('D', '禁用')], default='E', max_length=1, verbose_name='状态')),
                ...
                ('tags', models.ManyToManyField(blank=True, db_constraint=False, to='common_objects.commontag', verbose_name='标签')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('type', django_task_system.common_objects.fields.CharField(choices=[('C', 'Crontab'), ('O', '一次性'), ('S', '连续性')], default='S', max_length=1, verbose_name='计划类型')),
                ('crontab', models.CharField(blank=True, max_length=50, null=True, verbose_name='Crontab表达式')),
                ...
                ('status', django_task_system.common_objects.fields.CharField(choices=[('O', '开启'), ('C', '关闭'), ('D', '已完成'), ('T', '测试')], default='O', max_length=1, verbose_name='状态')),
                ('create_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='创建时间')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('status', django_task_system.common_objects.fields.CharField(max_length=1, verbose_name='运行状态')),
                ('result', django_task_system.common_objects.fields.ConfigField(blank=True, null=True, verbose_name='结果')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True, verbose_name='描述')),
                ('trigger_event', django_task_system.common_objects.fields.CharField(choices=[('S', '成功'), ('F', '失败'), ('D', '完成')], default='D', max_length=1, verbose_name='触发事件')),
                ('status', django_task_system.common_objects.fields.CharField(choices=[('E', '启用'), ('D', '禁用')], default='E', max_length=1, verbose_name='状态')),
                ('config', django_task_system.common_objects.fields.ConfigField(blank=True, default=django_task_system.common_objects.models.get_default_config('TaskCallback'), null=True, verbose_name='参数')),
                ('create_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='创建时间')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('user', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='用户')),
            ],
        ...
        migrations.AddField(
            model_name='taskschedule',
            name='task',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='task_schedule.task', verbose_name='任务'),
        ),
        migrations.AddField(
            model_name='taskschedule',
            name='user',
